...
class SoccerRobot:
    def __init__(self):
        ...
        self.max_speed = 15000000  # Maximum speed for all movements
        self.forward_speed = 0.7  # Forward movement speed (70% of max)
        self.turn_sensitivity = 1.2  # Turn sensitivity (120% of max speed for full error)
    ...
    def setup_motors(self, force_calibration=False):
        ...
        for i, addr in enumerate(motor_addresses):
            ...
            motor.set_current_limit_foc(2*65536)
